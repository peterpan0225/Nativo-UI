  ...
  const uploadFilesPinata = async ()=> {
    ...
    if (!mint.avatar){
      Swal.fire({
       ...
       html:
          '<div class="">' +
          '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' + t("CreateCol.erruploadAvatar")+ '</div>' +
    ...
    if (!mint.banner){
      Swal.fire({
       ...
       html:
          '<div class="">' +
          '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' + t("CreateCol.erruploadBanner")+ '</div>' +
...
+   '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' + type ? t("CreateCol.EditingCollection") : t("CreateCol.uploadingAvatar")  + '</div>' 
