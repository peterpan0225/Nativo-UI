        ...
        <div className=" flex  px-5  flex-row items-center movil-header dark:bg-[#0A0A0A] h-[80px]">
...

          {
            stateLogin ?
                  ...
                  <Menu isOpen={state.isOpen} onStateChange={()=>handleMenuStateChange()} pageWrapId={'page-wrap'} outerContainerId={'outer-container'}  >
                    ...
                    <div className="menu-item" >
                      <div className="font-open-sans font-extrabold text-base leading-4 flex text-white mt-12 justify-between uppercase " >
                        ...
                        <div className={classNames(showExploreSubMenu ? "transform -translate-x-[620px] duration-600" : "transform -translate-x-80 duration-100", "w-[300px] h-full dark:bg-[#0A0A0A]  fixed z-[1200] -right-[620px] top-[80px] px-[42px]")}>
                    ...
                    <div className="menu-item" >
                      <div className="font-open-sans font-extrabold text-base leading-4 flex text-white mt-3 justify-between uppercase">
                    ...
                    <button className="flex  rounded-xlarge w-full h-[40px]   lg:w-[159px] mt-10" onClick={handleSignIn}>
                      <div className="flex flex-col font-extrabold h-full text-white  text-center  justify-center shadow-s w-full border-solid border-2 rounded-md border-white2 hover:bg-outlineHover active:bg-outlinePressed ">
                    ...
                    <button className="flex  rounded-xlarge w-full h-[40px]  lg:w-[159px] mt-3" onClick={handleSignIn}>
                      <div className="flex flex-col font-extrabold h-full text-white  text-center  justify-center shadow-s w-full border-solid border-2 rounded-md border-white2 hover:bg-outlineHover active:bg-outlinePressed ">
              ...
              <>
                <button
                  className={`ml-auto mt-4 text-white bg-yellow2 border-0 py-2 px-6 focus:outline-none w-[320px] md:w-auto rounded-md font-open-sans font-extrabold uppercase hidden md:flex`}
                  style={{ justifyContent: "center" }}
                  // disabled={state?.tokens.onSale}
                  onClick={handleSignIn}>
                ...
                <div className="md:hidden">
                  <Menu isOpen={state.isOpen} onStateChange={()=>handleMenuStateChange()}  pageWrapId={'page-wrap'} outerContainerId={'outer-container'}  >
                    <button
                      className={` mt-3 text-white bg-yellow2 border-0 py-2 px-6 focus:outline-none w-[220px] md:w-auto rounded-md font-open-sans font-extrabold uppercase hidden md:flex`}
                      style={{ justifyContent: "center" }}
                      // disabled={state?.tokens.onSale}
                      onClick={handleSignIn}>
                    ...
                    <div className="menu-item" >
                      <div className="font-open-sans font-extrabold text-base leading-4 flex text-white mt-12 justify-between uppercase" >
                        ...
                        <div className={classNames(showExploreSubMenu ? "transform -translate-x-[620px] duration-100" : "transform -translate-x-80 duration-100", "w-[300px] h-full dark:bg-[#0A0A0A]  fixed z-[1200] -right-[620px] top-[89px]")}>
                          <button className="font-open-sans font-extrabold text-base leading-4 flex text-white mt-12 justify-between uppercase" onClick={handleExploreSubMenuShow}>
                            <img
                              className=""
                              src={menuArrowLeft}
                              alt='banner'
