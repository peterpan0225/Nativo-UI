              ...
              <>
                ...
                <div className="md:hidden">
                  <Menu isOpen={state.isOpen} onStateChange={() => handleMenuStateChange()} pageWrapId={'page-wrap'} outerContainerId={'outer-container'}  >
                    ...
                    <div className={classNames(showProfileSubMenu ? "transform -translate-x-[620px] duration-100" : "transform -translate-x-80 duration-100", "w-[300px] h-full dark:bg-[#0A0A0A]  fixed z-[1200] -right-[620px] top-[80px] px-[42px]")}>
                    ...
                    <div className="menu-item" >
                      ...
                      <div className={classNames(showFinanceSubMenu ? "transform -translate-x-[620px] duration-100" : "transform -translate-x-80 duration-100", "w-[300px] h-full dark:bg-[#0A0A0A]  fixed z-[1200] -right-[620px] top-[80px] px-[42px]")}>
