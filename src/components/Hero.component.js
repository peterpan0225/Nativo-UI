      ...
      <div className="container mx-auto flex px-5 pb-10 flex-col items-center md:items-center">
        <div className=" h-72 lg:h-96 lg:flex-grow  flex flex-col md:text-left items-center" >
          <div className="w-full z-20 pt-10">
            <h2 className="dark:text-white text-3xl mt-20  lg:text-5xl uppercase text-center font-raleway font-bold ">{t("Landing.title")}</h2>
            <h2 className="dark:text-white text-3xl lg:text-5xl uppercase text-center font-raleway font-bold">{t("Landing.title-2")}</h2>
            <div className="h-[4px]  bg-brown2 mt-[-11px] mx-auto " />
          </div>
          <p className="mt-8 leading-relaxed dark:text-white z-20 font-raleway font-normal text-center">
            {t("Landing.subtitle")}
          </p>
          <div className="flex justify-between z-20">
            <Link to="/gallery">
              <button className="flex inline-flex rounded-xlarge w-full h-[45px]  mt-0 bg-gradient-to-b p-[3px] from-yellow  to-brown hover:shadow-brown-s customHover" >
