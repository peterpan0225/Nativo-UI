          ...
          if (result.isConfirmed) {
            ...
            wallet.signAndSendTransaction({
              ...
              Swal.fire({
                ...
                html:
                  '<div class="">' +
                  '<div class="font-open-sans  text-base font-extrabold text-white mb-4 text-left uppercase">' +  t("Alerts.transferNFTTit") + '</div>' +
                  '<div class="font-open-sans  text-sm text-white text-left">' + t("Alerts.transferNFTMsg") + values.account + '</div>' +
                  '</div>',
